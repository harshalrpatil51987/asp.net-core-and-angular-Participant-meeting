...
{
    public abstract class eduvanzWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static eduvanzWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(eduvanzWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<eduvanzDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<eduvanzDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<eduvanzDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<eduvanzDbContext, Task<T>> func)
        {
            T result;
