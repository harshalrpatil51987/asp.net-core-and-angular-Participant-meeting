...
namespace eduvanz.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly eduvanzDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = eduvanzConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(eduvanzDbContext context)
        {
            _context = context;
        }
